                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($chiller as $key => $post) : ?>
                                                ...
                                                <tr class="align-middle">
                                                    <td><?php echo $post['status_chiller2'] ?></td>
                                                    <td><?php echo $post['out_temp_chiller2'] ?>°C</td>
                                                    <td><?php echo $post['in_temp_chiller2'] ?>°C</td>
                                                    <td><?php echo $post['amb_temp_chiller2'] ?>°C</td>
                                                    <td><?php echo $post['free_temp_chiller2'] ?>°C</td>
                                                    <td><?php echo $post['setpoint_chiller2'] ?>°C</td>
                                                    <td><?php echo $post['pump1_chiller2'] ?>%</td>
                                                    <td><?php echo $post['pump2_chiller2'] ?>%</td>
                                                    <td><?php echo $post['conden1_chiller2'] ?> bar</td>
                                                    <td><?php echo $post['conden2_chiller2'] ?> bar</td>
                                                    <td><?php echo $post['cooling_chiller2'] ?> KW</td>
                                                    <td><?php echo $post['freecooling_chiller2'] ?> KW</td>
                                                    <td><?php echo $post['suction_chiller2'] ?> bar</td>
                                                    <td><?php echo $post['discharge_chiller2'] ?> bar</td>
                                                    <td><?php echo $post['flowrate_chiller2'] ?> l/min</td>
                                                    <td><?php echo $post['current_con_chiller2'] ?> Amp</td>
                                                    <td><?php echo $post['voltage_chiller2'] ?> Volt</td>
                                                    <td><?php echo $post['power_con_chiller2'] ?> KW</td>
                                                    <td><?php echo $post['eer_chiller2'] ?></td>
                                                    <td><?php echo $post['power_sup_chiller2'] ?></td>
                                                    <td><?php echo $post['alarm_chiller2'] ?></td>
                                                    <td><?php echo $post['message_chiller2'] ?></td>
                                                    <td><?php echo $post['rusak_chiller2'] ?></td>
                                                    <td><?php echo $post['alert_chiller2'] ?></td>
...
<script>
    ...
    async function fetchChartData() {
        ...
        try {
            const response = await fetch(`/chiller/getDataByMonth2?bulanChiller=${selectedMonth}&tahunChiller=${selectedYear}`);
            if (response.ok) {
    ...
    function updateLineChart(data) {
        ...
        const datasets = [

            {
                ...
                data: data.map(item => item.out_temp_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.in_temp_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.amb_temp_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.free_temp_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.setpoint_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.pump1_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.pump2_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.conden1_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.conden2_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.cooling_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.freecooling_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.suction_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.discharge_chiller2),
                borderColor: 'rgba(75, 192, 192, 1)',
                backgroundColor: 'rgba(75, 192, 192, 0.2)',
                pointRadius: 5,
                borderWidth: 1,
            ...
            {
                label: 'Flow Rate',
                data: data.map(item => item.flowrate_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.current_con_chiller2),
            ...
            {
                label: 'Voltage',
                data: data.map(item => item.voltage_chiller2),
            ...
            },
            {
                ...
                data: data.map(item => item.power_con_chiller2),
            ...
            {
                label: 'EER',
                data: data.map(item => item.eer_chiller2),
            ...
            {
                label: 'Power Supply',
                data: data.map(item => item.power_sup_chiller2),
...
<script>
    ...
    document.getElementById('exportExcelButton').addEventListener('click', function() {
        window.location.href = '<?= site_url('export-chiller2') ?>'; // Menggunakan rute yang sudah didefinisikan
    });
</script>
