    ...
    async function fetchChartData() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const labels = data.map(item => item.rusak_pac1);
                const values = data.map(item => item.jumlah_kerusakan);
                chartKerusakanPac.data.labels = labels;
                chartKerusakanPac.data.datasets[0].data = values;
...
<script>
    ...
    var lineChart = new Chart(cty, {
        type: 'line',
        data: {
            labels: [], // Ini akan di-update dengan bulanPac-bulanPac
        ...
        options: {
            plugins: {
                title: {
                    display: true,
                    text: 'Grafik Berdasarkan bulan Pac'
                }
            },
        }
    });
    ...
    function updateLineChart(data) {
        ...
        const datasets = [
            ...
            {
                label: 'Suhu PAC 1',
                data: data.map(item => item.suhu_pac1),
                borderColor: 'rgba(75, 192, 192, 1)',
                backgroundColor: 'rgba(75, 192, 192, 0.2)',
                pointRadius: 5,
                borderWidth: 1,
            ...
            {
                label: 'Suhu PAC 2',
                data: data.map(item => item.suhu_pac2),
            ...
            {
                label: 'Suhu PAC 3',
                data: data.map(item => item.suhu_pac3),
            ...
            {
                label: 'Suhu PAC 4',
                data: data.map(item => item.suhu_pac4),
            ...
            {
                label: 'Suhu PAC 5',
                data: data.map(item => item.suhu_pac5),
            ...
            {
                label: 'Suhu PAC 6',
                data: data.map(item => item.suhu_pac6),
            ...
            {
                label: 'Temperature PAC 1',
                data: data.map(item => item.temp_pac1),
            ...
            {
                label: 'Temperature PAC 2',
                data: data.map(item => item.temp_pac2),
            ...
            {
                label: 'Temperature PAC 3',
                data: data.map(item => item.temp_pac3),
            ...
            {
                label: 'Temperature PAC 4',
                data: data.map(item => item.temp_pac4),
            ...
            {
                label: 'Temperature PAC 5',
                data: data.map(item => item.temp_pac5),
            ...
            {
                label: 'Temperature PAC 6',
                data: data.map(item => item.temp_pac6),
    ...
    async function fetchChartData() {
        ...
        try {
            const response = await fetch(`/pac/getChartDataByMonth?bulanPac=${selectedMonth}&tahunPac=${selectedYear}`);
            if (response.ok) {
                const data = await response.json();
                console.log(data);
